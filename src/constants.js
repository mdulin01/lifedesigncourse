...
export const courseModules = [
  ...
  },
  {
    ...
    subtitle: 'Book Club — What Matters Most to You',
    description: 'Explore why you work and what gives your life meaning. Identify your core values and check how well your current life reflects them.',
    icon: '🧭',
    framework: 'dyl',
    color: 'from-emerald-500/20 to-teal-500/20',
    borderColor: 'border-emerald-500/30',
    tools: ['Values Assessment', 'Work Reflection', 'Life Reflection'],
  },
  {
    id: 3,
    title: 'Energy Mapping',
    subtitle: 'Book Club — What Fuels You vs. Drains You',
    description: 'Track your daily activities and discover what gives you energy vs. what drains you. Look at the who, what, where, and how behind your best and worst moments.',
    icon: '⚡',
    framework: 'dyl',
    color: 'from-yellow-500/20 to-amber-500/20',
    borderColor: 'border-yellow-500/30',
    tools: ['Activity Logger', 'Energy Tracker', 'Pattern Finder'],
  },
  {
    id: 4,
    title: 'Life Path Planning',
    subtitle: 'Book Club — Three Possible Futures',
    description: 'Sketch three different 5-year visions for your life: where you\'re headed now, an alternate path, and a wild-card dream. Compare them and pick one to test.',
    icon: '🗺️',
    framework: 'dyl',
    color: 'from-purple-500/20 to-violet-500/20',
    borderColor: 'border-purple-500/30',
    tools: ['Life Path Builder', 'Comparison Tool', 'Decision Guide'],
  },
  {
    id: 5,
    title: 'Building Better Habits',
    subtitle: 'Book Club — Small Changes, Big Results',
    description: 'Focus on who you want to become, not just what you want to achieve. Learn practical strategies to make good habits easy to start and bad habits hard to keep.',
    icon: '🔄',
    framework: 'ah',
    color: 'from-orange-500/20 to-red-500/20',
    borderColor: 'border-orange-500/30',
    tools: ['Habit Builder', 'Strategy Checklist'],
  },
  {
    id: 6,
    title: 'Life Balance Check',
    subtitle: 'Book Club — Health, Work, Play, Love',
    description: 'Rate how satisfied you are across four areas of life. See where you\'re thriving, where you need attention, and track how things shift over time.',
    icon: '📊',
    framework: 'dyl',
    color: 'from-teal-500/20 to-emerald-500/20',
    borderColor: 'border-teal-500/30',
    tools: ['Balance Rating', 'Trend Tracker', 'Focus Planner'],
  },
  {
    id: 7,
    title: 'Habit Tracking & Streaks',
    subtitle: 'Book Club — Building Momentum',
    description: 'Set up a simple system to track your habits, build streaks, and design your environment to support the changes you want to make.',
    icon: '📈',
    framework: 'ah',
    color: 'from-rose-500/20 to-pink-500/20',
    borderColor: 'border-rose-500/30',
    tools: ['Habit Tracker', 'Streak Counter', 'Environment Design'],
  },
  {
    id: 8,
    title: 'Test & Adjust',
    subtitle: 'Book Club — Try It Before You Commit',
    description: 'Run small experiments to test your ideas before making big changes. Review what you\'ve learned, adjust your approach, and keep moving forward.',
    icon: '🧪',
    framework: 'both',
    color: 'from-indigo-500/20 to-blue-500/20',
    borderColor: 'border-indigo-500/30',
    tools: ['Experiment Planner', 'Review Log'],
  },
];
...
// Activity analysis prompts (what, where, who, how)
export const journalPrompts = {
  activity: 'What were you doing? Was it structured or free-form?',
  environment: 'Where were you? How did the setting affect your mood?',
  interactions: 'Who were you with? Were you collaborating, competing, or working alone?',
  objects: 'What tools or devices were you using?',
  users: 'Who else was involved? Who was affected by what you were doing?',
};
